...
$sql = "insert into  case_type (case_type_name) values ('$case_type_name')";
	// echo 	$sql;
  // die;
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" action="case_type_info.php" method="post">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Case Type Name</label>
                  <div class="col-sm-6">
                    <input type="text" name="case_type_name" class="form-control">
                  </div>
                  </div>
