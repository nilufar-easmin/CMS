  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
	  	...
	  	<div>
			<div class="div1">Court Type List</div>
			<div class="div2">
...
if(isset($_GET['court_type_id'])){
	//echo $_GET['court_type_id']; die;
	$court_type_id = $_GET['court_type_id'];
	$sql="delete from court_type  where court_type_id =$court_type_id";
	//echo $sql;
	//die;
	$conn->query($sql);
			...
			<?php /*?><tr style='background-color:purple; height:30px; text-align:center; color:black; font-weight:bold;'><?php */?>
              ...
              <hr>
			  	<?php
                   ...
                   <td>
							<a href='court_type_info_edit.php?court_type_id=$court_type_id' class='button2'>Update</a>
							<a href='court_type_view.php?court_type_id=$court_type_id' class='btn btn-primary'>View</a>
							<a href ='$_SERVER[SCRIPT_NAME]?court_type_id=$court_type_id'
