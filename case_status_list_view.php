  ...
  <section id="container">
  	...
  	<?php
		...
		if(isset($_GET['case_status_id'])){
			...
			$sql="delete from case_status where case_status_id =$case_status_id";
			//echo $sql;
			//die;
			$conn->query($sql);
    ...
    <section id="main-content">
      <section class="wrapper">
	  	...
	  	<div>
			<div class="div1">Case Status List</div>
			<div class="div2">
				<a href="case_status_info.php" class="button1">Add New Case Status</a>
			</div>
		</div>
              ...
              <hr>
			  	<?php
					...
					while($row = mysqli_fetch_array($rec))
					{
						...
						echo "<tr>
						<td>$i</td>
						<td>$case_status_name </td>
						
                   <td>
							<a href='case_status_info_edit.php?case_status_id=$case_status_id' class='button2'>Update</a>
							<a href='case_status_view.php?case_status_id=$case_status_id' class='btn btn-primary'>View</a>
							<a href ='$_SERVER[SCRIPT_NAME]?case_status_id=$case_status_id'
